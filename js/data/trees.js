 ...
 * art       Farben: trunk, leaf, leaf2 (Highlight), fruit; size = Bildgröße (1 = normal, <1 kleiner, >1 größer)
 */
FF.content.trees.push(
  { id: 'apple',  name: 'Apfelbaum',    cost: 150,     interval: 30, value: 15,
    art: { trunk: '#6b4423', leaf: '#3f9b3a', leaf2: '#58b94a', fruit: '#e63b2e', size: 0.8 } },

  { id: 'cherry', name: 'Kirschbaum',   cost: 1500,    interval: 30, value: 90,
    art: { trunk: '#5a3a22', leaf: '#e58fb5', leaf2: '#f4b3cf', fruit: '#b3122e', size: 0.92 } },

  { id: 'orange', name: 'Orangenbaum',  cost: 15000,   interval: 40, value: 320,
    art: { trunk: '#6b4423', leaf: '#2f8a3a', leaf2: '#49a84b', fruit: '#ff9a1a', size: 1.05 } },
