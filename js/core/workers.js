...
(function () {
  ...
  function isReady(e) {
    ...
    if (e.k === 'tree' || e.k === 'pen' || e.k === 'factory' || e.k === 'green' || e.k === 'mine') return e.n > 0;
    return false;
  }
  ...
  function pick(w) {
    ...
    for (let i = 0; i < ents.length; i++) {
      const e = ents[i];
      if ((e.k !== 'field' && e.k !== 'tree' && e.k !== 'pen' && e.k !== 'factory' && e.k !== 'green' && e.k !== 'mine') || reserved.has(e) || !isReady(e)) continue;
